    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_premiere', models.DateField(default=datetime.date.today, verbose_name='Премера в мире')),
                ('budget', models.PositiveIntegerField(default=0, help_text='указывать сумму в доларах', verbose_name='Бюджет')),
                ('fess_in_usa', models.PositiveIntegerField(default=0, help_text='указывать сумму в доларах', verbose_name='Сборы в США')),
                ...
                ('actors', models.ManyToManyField(related_name='film_actor', to='movies.Actor', verbose_name='актері')),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movies.Actor', verbose_name='режыссер')),
