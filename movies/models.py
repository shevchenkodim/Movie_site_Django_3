...
class Movie(models.Model):
    ...
    directors = models.ManyToManyField(Actor, verbose_name="режыссер", related_name="film_director")
    actors = models.ManyToManyField(Actor, verbose_name="актері", related_name="film_actor")
